...
ToolSystem - GameObjects, привязанные к руке игрока, ими управляет компонент ToolSystem, 
...
каждый Tool - это обычный класс, сейчас рассмотрим цикл тула на одном примере:
Игрок сломал камень - выпал GameObject(обертка ресура) - при касании, прибавляется в инвентарь ресурс - 
игрок берет его в тулбар - тулбар говорит ToolSystem, что equip и передает ресурс - TooSystem вытаскивает тип тула, через реестр и создает его через фабрику -
